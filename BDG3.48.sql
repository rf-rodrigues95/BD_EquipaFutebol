...
CREATE OR REPLACE FORCE VIEW "JOGOSVIEW" ("DATAJOGO", "CASA", "EQUIPAID", "HORA", "RESULTADO", "VALOR") AS 
  SELECT 
  J.DATAJOGO, J.CASA, J.EQUIPAID, J.HORA, J.RESULTADO, J.VALOR
FROM JOGO J
/
...
/* JOGO */
INSERT INTO JOGO (Hora, DataJogo,Resultado,Casa ,EquipaID, Valor)
VALUES (2000, DATE '2023-05-20', '1-0', 1, 1,'V');
COMMIT;

INSERT INTO JOGO (Hora, DataJogo,Resultado,Casa ,EquipaID)
VALUES (1900, DATE '2023-06-05', '3-1', 0, 1, 'V');
COMMIT;
...
commit;
select * from acoes where nif = 201801101;
select * from convocatoria where hora = 2000 and nif = 201801101;
